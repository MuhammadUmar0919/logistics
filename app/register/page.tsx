...
export default function RegisterPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    await register(values.name, formattedPhone, values.email, values.password)
  }
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Platformadan foydalanish uchun ro&apos;yxatdan o&apos;ting</p>
          </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" placeholder="Email manzilingizni kiriting" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
